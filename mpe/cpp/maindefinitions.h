...
#define COPYRIGHT_STRING    "(C)2019 IC Book Labs."
#define ANY_KEY_STRING      "Press any key..."

// Build type strings definition
#if __i386__ & _WIN32
#define BUILD_STRING "v0.60.09 for Windows ia32."
#define NATIVE_LIBRARY_NAME "mpe32.dll"
#define NATIVE_WIDTH 32
#elif __x86_64__ & _WIN64
#define BUILD_STRING "v0.60.09 for Windows x64."
#define NATIVE_LIBRARY_NAME "mpe64.dll"
...
typedef enum {
CPU_FEATURE_READ_IA32_X64,       // ID = 0
...
CPU_FEATURE_NTW_COPY_AVX512,     // ID = 25
// Additions for non-temporal Read, 
// NTRW = non-temporal read and write ((V)MOVNTDQA)
CPU_FEATURE_NTRW_READ_SSE128,    // ID = 26
CPU_FEATURE_NTRW_COPY_SSE128,
CPU_FEATURE_NTRW_READ_AVX256,
CPU_FEATURE_NTRW_COPY_AVX256,
CPU_FEATURE_NTRW_READ_AVX512,
CPU_FEATURE_NTRW_COPY_AVX512,    // ID = 31
// Additions for non-temporal by Prefetch Read, 
// NTPRW = non-temporal prefetched read and write (PREFETCHNTA)
CPU_FEATURE_NTPRW_READ_SSE128,   // ID = 32
CPU_FEATURE_NTPRW_COPY_SSE128,   // ID = 33, this duplicated 1
CPU_FEATURE_NTPRW_READ_AVX256,   // ID = 34, compare with text asm keys, possible wrong, REQUIRED CORRECTION
...
CPU_FEATURE_LATENCY_LCM,       // ID = 35, Address randomization by Linear Congruential Method
CPU_FEATURE_LATENCY_RDRAND,    // ID = 36, Address randomization by RDRAND instruction
CPU_FEATURE_LATENCY_WALK       // ID = 37, Walk linked list, generated by LCM or RDRAND
} CPU_FEATURES;
